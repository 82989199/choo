...
public class S_ReturnedStat extends ServerBasePacket {
	...
	public static final int OPEN_SLOT_LRING		= 0x04;	// 왼쪽 반지.
	public static final int OPEN_SLOT_RRING		= 0x08;	// 오른쪽 반지
	public static final int OPEN_SLOT_EARRING	= 0x10;	// 귀걸이 반지
	public static final int OPEN_SLOT_SHOULD 	= 0x40;	// 견갑 value.
	public static final int OPEN_SLOT_BADGE 	= 0x80;	// 휘장 value.
	public static final int OPEN_SLOT_ALL			= OPEN_SLOT_LRING | OPEN_SLOT_RRING | OPEN_SLOT_EARRING | OPEN_SLOT_SHOULD | OPEN_SLOT_BADGE;
	 ...
	 * writeC(Opcodes.S_VOICE_CHAT); writeC(a); writeD(b); writeD(c); for (int i
	 * = 0; i < 23; i++) writeC(0); }
	 */
	...
	public S_ReturnedStat(L1PcInstance pc, int type, String action) {
		...
		// // 슬롯 착용된 갯수.
		// writeC( (pc.getEquipSlot().getWeapon()==null?0:1) +
		// pc.getEquipSlot().getArmors().size() );
		// /*
		// * 투구 - 1
		// * 갑옷 - 2
		// * 티셔츠 - 3
