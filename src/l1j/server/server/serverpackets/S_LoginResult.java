...
public class S_LoginResult extends ServerBasePacket {
	...
	public static final int BANNED_REASON_HACK = 95; 	//  95-고객님의 계정은 불법프로그램 사용으로 인하여 게임 서비스 이용이 제한된 상태입니다.
	public static final int BANNED_REASON_NOMANNER = 62;	//  62-고객님의 계정은 공공의 안녕, 질서나 미풍양속을 해하는 행위.....
	public static final int BANNED_REASON_COMMERCE = 87;	//  87-고객님께서는 상업적인 목적의 광고 행위 또는 현금/타게임과의 거래 등을 시도 하신 것이 확인되어....
