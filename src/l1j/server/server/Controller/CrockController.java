...
//	private boolean gmopen = false;//원본
	
	public boolean gmopen = false;
...
//				L1SpawnUtil.spawn2(33452, 32812, (short) 4, 200, 0, 86400 * 1000, 0);//기란
...
//				L1Teleport.teleport(c, 33970, 33246, (short) 4, 4, true);
				c.start_teleport(33970, 33246, 4, 5, 169, true, false);
			}
		}
	}
