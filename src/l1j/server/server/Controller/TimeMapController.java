			...
			for (L1TimeMap timeMap : array()) {
				if (timeMap.count()) {
					for (L1PcInstance pc : L1World.getInstance().getAllPlayers()) {
						...
						case 73:
						case 74:
							pc.start_teleport(34056, 32279, 4, 5, 169, true, false);
							break;
						case 460:
						case 461:
						case 462:
						...
						case 465:
						case 466:
							pc.start_teleport(32664, 32855, 457, 5, 169, true, false);
							break;
						case 470:
						case 471:
						case 472:
						case 473:
						case 474:
							pc.start_teleport(32663, 32853, 467, 5, 169, true, false);
							break;
						case 475:
						case 476:
						case 477:
						case 478:
							pc.start_teleport(32660, 32876, 468, 5, 169, true, false);
							break;
						default:
							break;
						}
