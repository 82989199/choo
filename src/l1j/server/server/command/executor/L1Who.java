...
public class L1Who implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			pc.sendPackets(new S_ChatPacket(pc,"\\aD=========== 접속중인 플레이어 수 ==========="));
			pc.sendPackets(new S_ChatPacket(pc,"\\aL[로봇] : " + robotcount));
			pc.sendPackets(new S_ChatPacket(pc,"\\aH[유저] 총인원수: " + playercount));
			pc.sendPackets(new S_ChatPacket(pc,"\\aJ[무인상점] : " + AutoShopUser));
			pc.sendPackets(new S_ChatPacket(pc,"\\aE[뻥튀기] : " + CalcUser));
