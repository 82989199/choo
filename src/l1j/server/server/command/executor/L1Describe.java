...
public class L1Describe implements L1CommandExecutor {
	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			pc.sendPackets(new S_ChatPacket(pc, String.format("* 기술내성:%d 정령내성:%d 용언내성:%d 공포내성:%d 전체내성:%d", 
			...
			pc.sendPackets(new S_ChatPacket(pc, String.format("* 기술적중:%d 정령적중:%d 용언적중:%d 공포적중:%d 전체적중:%d", 
			...
			pc.sendPackets(new S_ChatPacket(pc,"* PVP댐지감소: " + target.getResistance().getcalcPcDefense()));
