...
public class L1SupportInstance extends L1NpcInstance {
	...
	public L1SupportInstance(L1Npc template, L1PcInstance master, int supportType, int itemObjId) {
		super(template);
		...
		GeneralThreadPool.getInstance().schedule(new SupportTimer(), SUPPORT_TIME);
		setMaster(master);
