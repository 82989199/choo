...
//	}
    ...
    skillIds = new int[] {COOKING_1_15_N, COOKING_1_15_S ,수련자의닭고기스프
    		
    ,COOKING_1_7_N,COOKING_1_7_S,COOKING_1_23_N,COOKING_1_23_S,COOK_GROW,COOK_GROW_1
    };
   ...
   /* if (pc.hasSkillEffect(skillIds[i])) {
    ...
    eatCooking(pc, L1SkillId.COOK_GROW_1, 1800);
