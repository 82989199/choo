  ...
  extends L1ItemInstance
{
  ...
  private static void 메티스스프1(L1PcInstance pc, int item_id)
  {
...
//	}
    ...
    ,COOK_STR,COOK_DEX,COOK_INT,메티스정성스프,COOK_STR_12,COOK_INT_1,COOK_DEX_1
    ,COOK_STR_1
    };
   ...
   /* if (pc.hasSkillEffect(skillIds[i])) {
    ...
    eatCooking(pc, L1SkillId.메티스정성스프, 1800);
//		switch (item_id) {
//		case 3100129:
