...
public class infomation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("자세히보기");
        jMenuItem1.setToolTipText("정보창을 늘리고 줄일수 있습니다.");
        ...
        jMenuItem2.setText("새로고침");
        jMenuItem2.setToolTipText("정보를 새로 업데이트합니다.");
        ...
        iframe1.setToolTipText("캐릭터 정보창");
        ...
        ImageIcon i3=new ImageIcon("C:/Documents and Settings/zzaz/My Documents/Icon/jisoo1021_1_m.gif");
       ...
       String ClassId = "";
        ...
        case 0:ClassId = "data/img/남군주.jpg";break;
        case 1:ClassId = "data/img/여군주.jpg";break;
        case 61:ClassId = "data/img/남기사.jpg";break;
        case 48:ClassId = "data/img/여기사.jpg";break;
        case 138:ClassId = "data/img/남요정.jpg";break;
        case 37:ClassId = "data/img/여요정.jpg";break;
        case 734:ClassId = "data/img/남법사.jpg";break;
        case 1186:ClassId = "data/img/여법사.jpg";break;
        case 2786:ClassId = "data/img/남다엘.jpg";break;
        case 2796:ClassId = "data/img/여다엘.jpg";break;
        case 6658:ClassId = "data/img/남용기사.jpg";break;
        case 6661:ClassId = "data/img/여용기사.jpg";break;
        case 6671:ClassId = "data/img/남환술사.jpg";break;
        case 6650:ClassId = "data/img/여환술사.jpg";break;
        case 12490:ClassId = "data/img/남전사.jpg";break;
        case 12494:ClassId = "data/img/여전사.jpg";break;
       ...
       img.setHorizontalTextPosition(javax.swing.JLabel.CENTER);
        ...
        jLabel17.setFont(new java.awt.Font("굴림", 1, 12));
        jLabel17.setForeground(new java.awt.Color(0, 153, 51));
        jLabel17.setText("* 캐릭터 스텟정보 *");

        jLabel18.setFont(new java.awt.Font("굴림", 1, 12));
        jLabel18.setForeground(new java.awt.Color(0, 0, 255));
        jLabel18.setText("힘    : ");

        jLabel19.setFont(new java.awt.Font("굴림", 1, 12));
        jLabel19.setForeground(new java.awt.Color(0, 0, 255));
        jLabel19.setText("덱스 : ");

        jLabel20.setFont(new java.awt.Font("굴림", 1, 12));
        jLabel20.setForeground(new java.awt.Color(0, 0, 255));
        jLabel20.setText("콘    : ");

        jLabel21.setFont(new java.awt.Font("굴림", 1, 12));
        jLabel21.setForeground(new java.awt.Color(0, 0, 255));
        jLabel21.setText("위즈       : ");

        jLabel22.setFont(new java.awt.Font("굴림", 1, 12));
        jLabel22.setForeground(new java.awt.Color(0, 0, 255));
        jLabel22.setText("인트      : ");

        jLabel23.setFont(new java.awt.Font("굴림", 1, 12));
        jLabel23.setForeground(new java.awt.Color(0, 0, 255));
        jLabel23.setText("카리스마 : ");
		...
		String clas;
		switch(pc.getType()){
		    case 0:clas = "King";break;
			case 1:clas = "Knight";break;
			case 2:clas = "Elf";break;
			case 3:clas = "Wizard";break;
			case 4:clas = "Darkelf";break;			
			default:clas = "(에러)";break;
		}
        ...
        jInternalFrame1.setToolTipText("기타 정보창");
       ...
       if (pc.getClanname() != null){
		...
		if(clan != null){
		  ...
		  LeaderName = clan.getLeaderName();
			...
			case 1:Castle = "켄트성";break;
			case 2:Castle = "오크 요새";break;
			case 3:Castle = "윈다우드성";break;
			case 4:Castle = "기란성";break;
			case 5:Castle = "하이네성";break;
			case 6:Castle = "지저성";break;
			case 7:Castle = "아덴성";break;
			case 8:Castle = "디아드 요새";break;
			default:Castle = "(없음)";break;
		}
		}else if(clan == null){
			ClanName = "(혈맹 없음)";			
		}
        ...
        jTabbedPane1.addTab("혈맹", jLayeredPane2);		
        ...
        jTabbedPane1.addTab("스킬", jScrollPane1);		
        ...
        jTabbedPane1.addTab("아이템", jScrollPane2); 		
    ...
    jTable3.setModel(new javax.swing.table.DefaultTableModel(layta2,           
        ...
        jTabbedPane1.addTab("창고", jScrollPane3);
        ...
        jTabbedPane1.addTab("펫", jScrollPane4);
...
private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
    ...
    if(chocco.serverstart){
        javax.swing.JOptionPane.showMessageDialog(this, "서비스 준비중입니다.", "Server Message", javax.swing.JOptionPane.INFORMATION_MESSAGE);
	/** 서버가 실행중이지 않다면 */
    }else{
        javax.swing.JOptionPane.showMessageDialog(this, "서버가 실행되지 않았습니다.", "Server Message", javax.swing.JOptionPane.ERROR_MESSAGE);
    }     
}
	...
	private String[][] skills(L1PcInstance pc) {
		...
		try {
			...
			while (rs.next()) {
				...
				if(l1skills.getSkillId() >= 1 && l1skills.getSkillId() <= 80){leaf = "일반마법";}
				else if(l1skills.getSkillId() >= 87 && l1skills.getSkillId() <= 91){leaf = "기사마법";}
				else if(l1skills.getSkillId() >= 97 && l1skills.getSkillId() <= 111){leaf = "흑정령마법";}
				else if(l1skills.getSkillId() >= 113 && l1skills.getSkillId() <= 120){leaf = "군주마법";}
				else if(l1skills.getSkillId() >= 129 && l1skills.getSkillId() <= 176){leaf = "정령마법";}
				else if(l1skills.getSkillId() >= 177 && l1skills.getSkillId() <= 200){leaf = "용언마법";}
				else if(l1skills.getSkillId() >= 201 && l1skills.getSkillId() <= 224){leaf = "환술마법";}
				else{leaf = "잘못된정보";}
					ttl[i][1] = leaf;				   
			}
