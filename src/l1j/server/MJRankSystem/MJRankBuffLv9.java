...
public class MJRankBuffLv9 extends MJRankBuff{
	...
	public MJRankBuffLv9(){
		...
		noti.set_spell_id(L1SkillId.RANK_BUFF_9);
		noti.set_duration(1);
	...
	public void onBuff(SC_TOP_RANKER_NOTI rnk) {
		...
		pc.setSkillEffect(L1SkillId.RANK_BUFF_9, -1);
		pc.sendPackets(_onBuffs, false);
		pc.addMaxHp(200);//HP
		pc.getAC().addAc(-3);
		pc.set_pvp_defense(2);//PVP대미지 리덕
		pc.addDmgupByArmor(1);
		pc.addBowDmgupByArmor(1);
	...
	public void offBuff(SC_TOP_RANKER_NOTI rnk) {
		...
		pc.killSkillEffectTimer(L1SkillId.RANK_BUFF_9);
