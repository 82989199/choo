...
//						pc.sendPackets(new S_ServerMessage(1480));  
						pc.sendPackets(new S_SystemMessage("시스템 메시지: 30초 후에 텔레포트 합니다."));
						//시스템 메시지:10초 후에 텔레포트 합니다.
					} 
					Thread.sleep(20000);
					if(pc.getMapId() == _map){ 
//						pc.sendPackets(new S_ServerMessage(1481));  
						pc.sendPackets(new S_SystemMessage("시스템 메시지: 20초 후에 텔레포트 합니다."));
						//시스템 메시지: 10초 후에 텔레포트 합니다.
					} 
					Thread.sleep(10000);
					if(pc.getMapId() == _map){ 
//						pc.sendPackets(new S_ServerMessage(1482));  
						pc.sendPackets(new S_SystemMessage("시스템 메시지: 10초 후에 텔레포트 합니다."));
						//시스템 메시지: 3초 후에 텔레포트 합니다.
					} 
					Thread.sleep(5000);
					if(pc.getMapId() == _map){ 
//						pc.sendPackets(new S_ServerMessage(1483));  
						pc.sendPackets(new S_SystemMessage("시스템 메시지: 5초 후에 텔레포트 합니다."));
						//시스템 메시지: 2초 후에 텔레포트 합니다.
					} 
					Thread.sleep(3000);
					if(pc.getMapId() == _map){ 
//						pc.sendPackets(new S_ServerMessage(1484));  
						pc.sendPackets(new S_SystemMessage("시스템 메시지: 3초 후에 텔레포트 합니다."));
						//시스템 메시지: 1초 후에 텔레포트 합니다.
					} 
					Thread.sleep(1000);
					if(pc.getMapId() == _map){ 
//						L1Teleport.teleport(pc, 33705, 32504, (short)4, 5, true);
						pc.start_teleport(33705, 32504, 4, 5, 169, true, false);
...
//	        System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■■■■■■ 화룡안식처 시작 " +  _map+" ■■■■■■");
	        System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■화룡안식처 시작■캐릭터:"+pc.getName()+"■맵:"+_map+"■");
	}
...
//		        System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■■■■■■ 화룡안식처 종료 " +  _map+" ■■■■■■");
		        System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■화룡안식처 종료■캐릭터:"+pc.getName()+"■맵:"+_map+"■");
