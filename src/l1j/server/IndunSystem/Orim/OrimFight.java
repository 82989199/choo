...
//				L1Teleport.teleport(summonChar, 32673, 32801, (short)9101, 2, true);
				summonChar.start_teleport(32673, 32801, 9101, 2, 169, true, false);
				break;
			case 1:
				for (int i = 0; i < 3; i++) {
...
//				L1Teleport.teleport(summonChar, 32735, 32862, (short)9101, 2, true);
				summonChar.start_teleport(32735, 32862, 9101, 2, 169, true, false);
				break;
			case 2:
				for (int i = 0; i < 3; i++) {
...
//				L1Teleport.teleport(summonChar, 32799, 32863, (short)9101, 2, true);
				summonChar.start_teleport(32799, 32863, 9101, 2, 169, true, false);
			}
...
//				L1Teleport.teleport(summonChar, 32582, 32927, (short)0, 4, true);
				summonChar.start_teleport(32582, 32927, 0, 5, 169, true, false);
			else {
//				L1Teleport.teleport(summonChar, 32797, 32801, (short)9101, 4, true);
				summonChar.start_teleport(32797, 32801, 9101, 5, 169, true, false);
			}
			ownEnd();
		}
	}
