...
//	  System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■■■■■■ 아이스데몬 종료 " +  _map+" ■■■■■■");
	System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■아이스데몬 종료■맵:"+_map+"■");
	}
...
//	  System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■■■■■■ 아이스데몬 시작 " +  _map+" ■■■■■■");
	System.out.println(""+ 오전오후 + " " + cal.get(시간) + "시" + cal.get(분) + "분" + "   ■아이스데몬 시작■맵:"+_map+"■");
	}
	...
	private void End() {
		for (L1Object obj : L1World.getInstance().getVisibleObjects(_map).values()) {
			if (obj instanceof L1PcInstance) {
				L1PcInstance pc = (L1PcInstance) obj;
//				L1Teleport.teleport(pc, 34068, 32311, (short)4, 4, true); // 이부분이 떨어질 좌표에요
				pc.start_teleport(34068, 32311, 4, 5, 169, true, false);
			}
		}
