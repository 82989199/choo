...
public class MJCaptcha {
	...
	private static final ServerBasePacket[][] _messages = new ServerBasePacket[][]{
		{
			new S_SystemMessage("오토방지 코드 인증에 성공했습니다."),
			new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "오토방지 코드 인증에 성공했습니다."),
		}, 
		{
			new S_SystemMessage("오토방지 코드 인증에 실패했습니다."),
			new S_PacketBox(S_PacketBox.GREEN_MESSAGE, "오토방지 코드 인증에 실패했습니다."),			
		},
	};
